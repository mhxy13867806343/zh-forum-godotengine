...
export const CATEGORY_TOPIC_COUNTS: Record<number, number> = {
  23: 300, // 官方公告
  6: 25000, // 求助问答总区 (~830 页)
  7: 12000, // 编程开发 (~400 页)
  9: 3500, // 物理系统 (~115 页)
  8: 4000, // 界面 UI (~130 页)
  10: 3000, // 着色器与特效 (~100 页)
  11: 2000, // 动画系统
  12: 1500, // 音频系统
  20: 8000, // 2D 游戏开发 (~260 页)
  21: 7000, // 3D 渲染与场景 (~230 页)
  25: 1200, // XR/VR
  4: 5000, // 综合交流 (General)
  13: 1500, // 网络与联机
  22: 1500, // 插件与扩展
  14: 1205, // 作品展厅 (Showcase 总计)
  15: 516, // 已发布游戏 (~58 页 @ 9/页)
  24: 566, // 在研项目 (DevLog ~63 页 @ 9/页)
  16: 123, // 辅助工具 (~14 页 @ 9/页)
  2: 500, // 论坛反馈
  19: 1500, // 社区资源
  17: 800, // 教程资产
  18: 600, // 实用插件
...
export function getCategoryTotalTopics(id?: number | null): number {
  if (!id) return 45000
  return CATEGORY_TOPIC_COUNTS[id] || 3000
}
