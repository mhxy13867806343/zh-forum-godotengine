import { B as DevframeDefinition, Q as McpSetting, V as DevframeDeploymentKind, Wt as DevframeAgentHost, X as McpAuthorization, t as ConnectionMeta } from "./context--tVkJw3W.mjs";
import { t as AgenticMcpModule } from "./agentic-DLqHMOyN.mjs";
 ...
 * bundle graph.
 */
declare function loadAutoMcpAdapter(agent: Pick<DevframeAgentHost, 'hasSurface'>): Promise<AgenticMcpModule | undefined>;
/**
 ...
 * same-server default).
 */
declare function resolveMcpConnectionMeta(mcp: McpSetting | undefined, port?: number): ConnectionMeta['mcp'];
//#endregion
