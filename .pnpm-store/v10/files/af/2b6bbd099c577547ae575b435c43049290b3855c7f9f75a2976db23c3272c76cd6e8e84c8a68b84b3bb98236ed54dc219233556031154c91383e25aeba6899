 ...
 */
export declare function defineConfig<T extends object = Theme>(config: UserConfig<T>): UserConfig<T>;
//#endregion
export { type PresetMiniTheme, type PresetUnoTheme, type PresetWind3Theme, type PresetWind4Theme, type PresetWindTheme, presetAttributify, presetIcons, presetMini, presetTagify, presetTypography, presetUno, presetWebFonts, presetWind, presetWind3, presetWind4, transformerAttributifyJsx, transformerCompileClass, transformerDirectives, transformerVariantGroup };