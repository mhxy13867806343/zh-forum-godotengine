...
export declare function ChunkModeBuildPlugin(ctx: UnocssPluginContext): Plugin;
//#endregion
//#region src/modes/global/build.d.ts
export declare function GlobalModeBuildPlugin(ctx: UnocssPluginContext<VitePluginConfig>): Plugin[];
//#endregion
//#region src/modes/global/dev.d.ts
export declare function GlobalModeDevPlugin(ctx: UnocssPluginContext): Plugin[];
//#endregion
//#region src/modes/global/index.d.ts
export declare function GlobalModePlugin(ctx: UnocssPluginContext): import("vite").Plugin<any>[];
//#endregion
//#region src/modes/per-module.d.ts
export declare function PerModuleModePlugin(ctx: UnocssPluginContext): Plugin[];
//#endregion
//#region src/modes/vue-scoped.d.ts
export declare function VueScopedPlugin(ctx: UnocssPluginContext): Plugin;
//#endregion
//#region src/index.d.ts
export declare function defineConfig<Theme extends object>(config: VitePluginConfig<Theme>): VitePluginConfig<Theme>;
export interface UnocssVitePluginAPI {
  getContext: () => UnocssPluginContext<VitePluginConfig>;
  getMode: () => VitePluginConfig['mode'];
}
export default function UnocssPlugin<Theme extends object>(configOrPath?: VitePluginConfig<Theme> | string, defaults?: UserConfigDefaults): Plugin[];
//#endregion