 ...
 */
declare function createRpcFunctions(ctx: UnocssPluginContext): readonly [import("devframe/rpc").RpcFunctionDefinitionWithoutSchemas<"get-project-info", "query", [], Promise<ProjectInfo>, undefined, undefined, undefined>, import("devframe/rpc").RpcFunctionDefinitionWithoutSchemas<"get-module-info", "query", [string], Promise<ModuleInfo | null> | null, undefined, undefined, undefined>, import("devframe/rpc").RpcFunctionDefinitionWithoutSchemas<"generate-repl", "query", [input: string, includeSafelist: boolean], Promise<ReplResult>, undefined, undefined, undefined>, import("devframe/rpc").RpcFunctionDefinitionWithoutSchemas<"get-overview", "query", [], Promise<OverviewInfo>, undefined, undefined, undefined>];
